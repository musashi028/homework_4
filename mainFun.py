...
import datetime
import os
from saveData import generate_question_summary_pairs
...
chat = ChatOpenAI(model="gpt-4o-mini",
                  ...
                  base_url=os.environ.get("BASE_URL")  # 替换为自定义API地址
                 )
...
raw_content_data = []
# 读取文件并分割数据样例
with open('/root/LLM-quickstart/chatglm/data/raw_data.txt', 'r', encoding='utf-8') as file:
    content = file.read()
    # 使用连续的换行符('\n\n')作为分隔符来分割文本
